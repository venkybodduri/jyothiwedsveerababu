    ...
    return (
      ...
      (t.CacheOnly = class {
        ...
        async handle({ event: t, request: e }) {
          ...
          if (!i) throw new n.WorkboxError("no-response", { url: e.url });
          return i;
        }
      }),
      (t.NetworkFirst = class {
        ...
        async p({ timeoutId: t, request: e, logs: n, event: r }) {
          let h, o;
          try {
      ...
      (t.StaleWhileRevalidate = class {
        ...
        async handle({ event: t, request: e }) {
          "string" == typeof e && (e = new Request(e));
          const i = this.o({ request: e, event: t });
          let r,
